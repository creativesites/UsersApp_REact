...
export default class EditProfile extends PureComponent {
    ...
    onEdit = () => {
        ...
        this.validate(Object.keys(this.requestBody), this.requestBody, async (status, response) => {
            if (status) {
                //Reset errors
                this.setState({
                    errors: [],
                ...
                const res = await fetch('http://localhost:8080/api/auth/updateUser', {
                    method: 'PUT',
    ...
    render() {
        const { name, email, password, job, salary } = this.state;
        const { screenType } = this.props;
                        ...
                        <div className="col-md-6">
                            <div className="box box-primary">
                                <div className="box-header with-border">
                                    <h3 className="box-title">Edit {this._getSubPageHeader()}!</h3>
                                </div>
                                <form onSubmit={this.submit.bind(this)} role="form">
                                    <div className="box-body">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="job" name="job" placeholder="Enter job title" value={job} onChange={this.onChangeText.bind(this)} />
                                            <p className="stm-input-error">{this.errors('job').message}</p>
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="salary">Salary</label>
                                            <input type="text" className="form-control" id="salary" name="salary" placeholder="Enter salary" value={salary} onChange={this.onChangeText.bind(this)} />
                                            <p className="stm-input-error">{this.errors('salary').message}</p>
                                        </div>
                                        <div className="form-group">
