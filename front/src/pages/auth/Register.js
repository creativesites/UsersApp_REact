                ...
                <div className="login-box container-center m-0">
                    ...
                    <div className="login-box-body">
                        ...
                        <form onSubmit={this.submit.bind(this)} method="post">
                            ...
                            <div className="form-group has-feedback">
                                <input type="text" className="form-control" placeholder="Job" name="job" onChange={this.onChangeText} />
                                <span className="fa fa-user form-control-feedback"></span>
                                <p className="stm-input-error">{this.errors('job').message}</p>
                            </div>
                            <div className="form-group has-feedback">
                                <input type="text" className="form-control" placeholder="Salary" name="salary" onChange={this.onChangeText} />
                                <span className="fa fa-user form-control-feedback"></span>
